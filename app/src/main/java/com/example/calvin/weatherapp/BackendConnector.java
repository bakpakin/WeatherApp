...
public class BackendConnector {
    ...
    // that doesn't cost money, we are using dummy data.
    private static double[] htempsData = {
            36.8,
            36.6,
            36.5,
            36.3,
    ...
    public void getCityDataByID(int id, int year) {
        ...
        for (int i = 0; i < htempsData.length; i++) {
            htemp.add(htempsData[i]);
        }
